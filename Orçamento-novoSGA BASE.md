...
- Unidade simples + 1 tela = R$ 2.000
- Até 12 pessoas = Incluso
- **TOTAL: R$ 1.000** ✅
...
TV Recepção:
  ├─ Senha Recepção: Pessoa-A
  ├─ Senha Recepção: Pessoa-B
  └─ Senha Recepção: Pessoa-C

TV Triagem:
  ├─ Senha Triagem: Pessoa-A
  ├─ Senha Triagem: Pessoa-B
  └─ Senha Triagem: Pessoa-C
```